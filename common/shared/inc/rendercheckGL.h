...
#ifdef _WIN32
    #pragma message ("Note: including <vector>")
    #pragma message ("Note: including <map>")
    #pragma message ("Note: including <string>")
    #pragma message ("Note: including GL/glew.h")
    #pragma message ("Note: including GL/glut.h")
#endif
